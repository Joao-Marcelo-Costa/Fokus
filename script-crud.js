...
const btCancelarAdicaoDeTarefa = document.querySelector(
  ".app__form-footer__button--cancel",
);
const btDeletarTarefaNoFormulario = document.querySelector(
  ".app__form-footer__button--delete",
);
const paragrafoDescricaoTarefa = document.querySelector(
  ".app__section-active-task-description",
);
const removerTarefasConcluidas = document.querySelector(
...
function criarElementoTarefa(tarefa) {
  //função que transforma uma tarefa object em um HTML dessa tarefa
  ...
  botaoEditar.onclick = () => {
    ...
    if (novaDescricao) {
      //verifica se ha algum valor em nova descrição
...
formAdicionarTarefa.addEventListener("submit", (evento) => {
  //evento ao clicar em salvar tarefa
...
removerTodasTarefas.onclick = (completas=false)=>{removerTarefas(false) }
